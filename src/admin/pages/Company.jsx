...
import { addCompany, deleteCompany, getAllCompanies, getSingleCompany, updateCompany } from "../../apiCalls/company";
import {
  addService,
  deleteService,
  getAllServices,
          ...
          <tbody>
            {companies.map((company) => (
              <tr key={company.id}>
                ...
                <td>
                  <img className="h-10 w-16 rounded" src={`http://localhost:5000/files/${company.image}`} alt="" />
                </td>
                <td>
                  {company.name}
                </td>
